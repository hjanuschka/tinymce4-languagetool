...
// Protect public server from accidents
...
lastActive=0;
        tarray.push(key);
       continue;
    } else if ( sgstore.viewport_process == 'nearby' && sgcheck[ key ].length >= 2 && lt_onscreen( $(sgstore['obj'][key]) ) == 0 ) {
lastActive=0;
        tarray.push(key);
       continue;
    }
                ...
                sgstore['run'].push({
                    ...
                    for (var i = 0; i < tlen; i++) {
                        ...
                        if ( uuid != undefined && sgstore['ignore']['all'][tempword] == undefined && (sgstore['ignore']['once'][uuid] == undefined || sgstore['ignore']['once'][uuid][tempword] == undefined) )  {
                            ...
                            lt_applyHighlighter( sgstore['obj'][ uuid ], i, tempword, item['rule']['id'], hclass, item['offset'], item['offset']+item['length']  );
                            locklist[ uuid ]=1;
...
// Backend Functions
 ...
 function lt_applyHighlighter ( myobj, myid, myword, myrule, myclass , mystart, myend ) {
    var alist = {};
